package com.lr.sia.mywidget.viewpager;
...
public class BannerViewPager extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init(Context context) {
        ...
        fl_banner_viewpager = view.findViewById(R.id.fl_banner_viewpager);
        vp_banner = view.findViewById(R.id.vp_banner);
        ll_scroll_banner_indicator = view.findViewById(R.id.ll_scroll_banner_indicator);
        addView(view);
    }
    ...
    public void setData(List<ImageView> views, List<String> list, OnItemClickListener listener, int showPosition) {
        ...
        for (int i = 0; i < indicators.length; i++) {
            ...
            indicators[i] = view.findViewById(R.id.iv_baner_indicator);
