...
import com.lr.sia.di.component.DaggerNetComponent;
...
public class JSONUtil {
    ...
    public List<Map<String, Object>> jsonToList(String json) {
        ...
        try {
            // json转为带泛型的list
            retList = gson.fromJson(json, new TypeToken<List<Map<String, Object>>>() {
            }.getType());
        } catch (Exception e) {
            return retList;
        }
    ...
    public List<List<String>> jsonToListStr2(String json) {
        ...
        try {
            // json转为带泛型的list
            retList = gson.fromJson(json, new TypeToken<List<List<String>>>() {
            }.getType());
        } catch (Exception e) {
            return retList;
        }
    ...
    public List<String> jsonToListStr(String json) {
        ...
        try {
            // json转为带泛型的list
            retList = gson.fromJson(json, new TypeToken<List<String>>() {
            }.getType());
        } catch (Exception e) {
            return retList;
        }
