...
import com.lr.sia.R;
import com.lr.sia.listener.CallBackTotal;
...
public class MyFriendListAdapter extends ListBaseAdapter implements Filterable {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        GlideUtils.loadCustRoundCircleImage(mContext, item.get("rc_portrait") + "", viewHolder.headIv, RoundedCornersTransformation.CornerType.ALL);
