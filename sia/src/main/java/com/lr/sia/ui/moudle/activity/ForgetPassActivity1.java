...
public class ForgetPassActivity1 extends BasicActivity implements View.OnClickListener {
    private ImageView ivBack;
    private TextView tvTitle, tvGetCode, tvChoosePhone;
    private LinearLayout llPass, llCheck;
    ...
    public void init() {
        ...
        phoneAreaPopup = new PhoneAreaPopup(ForgetPassActivity1.this);
