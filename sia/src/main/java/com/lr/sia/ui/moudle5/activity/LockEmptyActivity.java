...
import com.lr.sia.ui.moudle5.adapter.EmptyLockListAdapter;
...
public class LockEmptyActivity extends BasicActivity implements View.OnClickListener {
    ...
    private EmptyLockListAdapter emptyLockListAdapter;
    ...
    public int getContentView() {
        return R.layout.activity_lock_empty;
    }
    ...
    public void init() {
        ...
        rvLockLog.addItemDecoration(new DividerItemDecoration(LockEmptyActivity.this, DividerItemDecoration.VERTICAL));
        backImg.setOnClickListener(this);
        pageViewEmpty.setOnClickListener(this);
        tvReleaseLog.setOnClickListener(this);
        StatusBarUtil.setColorForSwipeBack(this, ContextCompat.getColor(this, MbsConstans.TOP_BAR_COLOR), MbsConstans.ALPHA);
        decimalFormat = new DecimalFormat("#.########");
        empty = getIntent().getStringExtra("empty");
        tvReleased.setText(getString(R.string.defaultReleased).replace("0.00", decimalFormat.format(Double.parseDouble(empty))));
        emptyLockListAdapter = new EmptyLockListAdapter(LockEmptyActivity.this);
        rvLockLog.setAdapter(emptyLockListAdapter);
        getLockListAction();
    ...
    private void getLockListAction() {
        ...
        if (UtilTools.empty(MbsConstans.ACCESS_TOKEN)) {
            MbsConstans.ACCESS_TOKEN = SPUtils.get(LockEmptyActivity.this, MbsConstans.SharedInfoConstans.ACCESS_TOKEN, "").toString();
        }
                ...
                switch (tData.get("code") + "") {
                    case "1": //请求成功
                        ...
                        if (tempList != null && tempList.size() > 0) {
                            emptyLockListAdapter.setDataList(tempList);
                    ...
                    case "-1": //token过期
                        finish();
                        intent = new Intent(LockEmptyActivity.this, LoginActivity1.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tvReleaseLog:
                intent = new Intent(LockEmptyActivity.this, ReleaseLockActivity.class);
