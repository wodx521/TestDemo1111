...
import com.lr.sia.ui.moudle.adapter.GuidePageAdapter;
...
public class GuideViewPageActivity extends BasicActivity implements RequestView {
    ...
    public void init() {
        ...
        mViewPager = findViewById(R.id.guidePages);
        mBottonLayout = findViewById(R.id.viewGroup);
        ...
        mStartBut = mViewList.get(mViewList.size() - 1).findViewById(R.id.startBtn);
        ...
        mStartBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent;
                if (bb) {
                    intent = new Intent(GuideViewPageActivity.this, LoginActivity1.class);
