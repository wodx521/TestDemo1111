...
public class ExchangeLogListAdapter extends RecyclerView.Adapter {
    private Context context;
    private LayoutInflater inflater;
    private List<Map<String, Object>> dataList;

    public ExchangeLogListAdapter(Context context) {
...
//        }
        lockListViewHolder.tvLockNum.setText(lockingAmount + coinName);
        lockListViewHolder.tvStatus.setText(lockingAmount + coinName);
