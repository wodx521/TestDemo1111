...
import com.lr.sia.ui.moudle.adapter.ViewPagerAdapter;
import com.lr.sia.utils.imageload.CircleProgressView;
...
public class ShowDetailPictrue extends BasicActivity implements View.OnClickListener {
    ...
    private void initViewPager() {
        ...
        mTipTv = findViewById(R.id.position_tv);
        mBackTv = findViewById(R.id.btn_back);
        mBackTv.setOnClickListener(this);
        mSaveTv = findViewById(R.id.btn_save);
        mSaveTv.setOnClickListener(this);
        mViewPager = findViewById(R.id.viewPager_show_bigPic);
        mFileList = mDataList;
        initView();
    }
    ...
    public void finish() {
        ...
        if (mViews != null) {
            for (int i = 0; i < mViews.size(); i++) {
                ...
                SubsamplingScaleImageView view = mRootView.findViewById(R.id.big_image_view);
