...
import com.lr.sia.R;
import com.lr.sia.ui.moudle5.adapter.ChooseListAdapter;
...
public class ChoosePopup {
    ...
    public ChoosePopup(Activity activity) {
    ...
    public void getPopup(TextView textView, List<Map<String, Object>> langList) {
        ...
        rvList.setAdapter(chooseListAdapter);
        chooseListAdapter.setMapList(langList);
