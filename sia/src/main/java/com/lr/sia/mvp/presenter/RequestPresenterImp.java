package com.lr.sia.mvp.presenter;
...
import com.lr.sia.mvp.base.BasePresenterImp;
...
import com.lr.sia.utils.tool.NetworkUtils;
...
//        }
     ...
     */
    @Override
    public void requestPostToMap(String mUrl, Map<String, Object> mParaMap) {
        //checkData();
        // mHeaderMap.put("Connection", "close");
        if (!NetworkUtils.isNetAvailable(context)) {
            Map<String, Object> errorMap = netErrorBack();
